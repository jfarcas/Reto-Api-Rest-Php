 ...
 *
 * @method Joke|null find($number, $lockMode = null, $lockVersion = null)
...
class JokeRepository extends ServiceEntityRepository
{
    ...
    public function add(Joke $entity, bool $flush = false): void
    {
    ...
    public function remove(Joke $entity, bool $flush = false): void
    {
